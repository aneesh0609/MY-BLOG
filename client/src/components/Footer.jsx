...
export default function FooterCom() {
  return (
    <Footer container className='border border-t-4 border-red-500 p-3'>
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid w-full justify-between sm:flex md:grid-cols-1">
          <div className="mt-5">
          <Link to="/" className="flex items-center space-x-2">
          <span className="text-lg sm:text-xl ml-5 mr-5 font-semibold dark:text-white bg-gradient-to-r from-indigo-500 via-purple-300 to-red-500 rounded-lg text-white px-2 py-1">
          CodeMew
          </span>
        </Link>
          </div>
        ...
        <Footer.Divider />
        <div className="">
          <Footer.Copyright href='#' by="2024 CodeMew" className='mt-5 mb-2' />
