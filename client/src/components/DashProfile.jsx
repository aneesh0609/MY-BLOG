  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <form className='flex flex-col gap-4'>
        ...
        <TextInput type='text' id='username' placeholder='username' defaultValue={currentUser.username} className='' />
        <TextInput type='email' id='email' placeholder='email' defaultValue={currentUser.email} className=' ' />
        <TextInput type='password' id='password' placeholder='password'  className=''/>
