     ...
     <div className='table-auto overflow-x-scroll md:mx-auto p-3 scrollbar scrollbar-track-slate-100 scrollbar-thumb-slate-300 dark:scrollbar-track-slate-700 dark:scrollbar-thumb-slate-500 '>
      {currentUser.isAdmin && users.length > 0 ? (
        <>
         ...
         <Table.Head>
              <Table.HeadCell className='p-4' >Date created</Table.HeadCell>
              <Table.HeadCell className='p-4' >User image</Table.HeadCell>
              <Table.HeadCell className='p-4' >Username</Table.HeadCell>
              <Table.HeadCell className='p-4' >Email</Table.HeadCell>
              <Table.HeadCell className='p-4' >Admin</Table.HeadCell> 
            ...
            {users.map((user) => (
              <Table.Body className='divide-y' key={user._id}>
                <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                  ...
                  <Table.Cell className='p-4'>{user.username}</Table.Cell>
